...
from slerobot.policies.utils import validate_visual_features_consistency
# from lerobot.policies.vqbet.configuration_vqbet import VQBeTConfig
# from lerobot.policies.wall_x.configuration_wall_x import WallXConfig
# from lerobot.policies.xvla.configuration_xvla import XVLAConfig
from slerobot.processor import PolicyAction, PolicyProcessorPipeline
from slerobot.processor.converters import (
    batch_to_transition,
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    if isinstance(policy_cfg, ACTConfig):
        from slerobot.policies.act.processor_act import make_act_pre_post_processors
